...
#
arquivo_info = open('info_hub.txt', 'w')
arquivo_info.write("Informações quanto ao grau dos 9 genes:\n\n")
#
for gene in genes:
	gene_name = gene.split()[0]
	arquivo_info.write("- ")
	...
	arquivo_info.write("\nGrau entrada: ")
	arquivo_info.write(str(d_genes[gene_name][0]['Grau entrada']))
	arquivo_info.write("\nGrau saida:   ")
	arquivo_info.write(str(d_genes[gene_name][0]['Grau saida']))
	arquivo_info.write("\n")
#
arquivo_info.write("\n----------------------------------------------------------------------\n")
