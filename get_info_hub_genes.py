			...
			if gene_name == gene_a or gene_name == gene_b:
				...
				if float(chance_0) >= 0.8:
					...
					if gene_name == gene_a:
						...
						#
						#print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA 11111111")
						#print(d_genes[gene_name])
						...
						for diciona in d_genes[gene_name]:
							if gene_b in diciona.values():
								...
								print('\n')
								gene_foi_salvo = True
								print("ACHEI UM REPTIDO EEEEEM\n")
								break
						#print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA 222222222")
